...
serve(async (req) => {
  ...
  try {
    ...
    // Handle sbksn (khasra search) with specific parameter order
    let body = '';
    if (act === 'sbksn') {
      body = `kcn=${kcn}&act=${act}&vcc=${vcc}&fasli-code-value=999&fasli-name-value=%E0%A4%B5%E0%A4%B0%E0%A5%8D%E0%A4%A4%E0%A4%AE%E0%A4%BE%E0%A4%A8+%E0%A4%AB%E0%A4%B8%E0%A4%B2%E0%A5%80`;
    } else {
